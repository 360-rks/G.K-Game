print("Ready to play a guess game. If you got less score then not a problem.Just play for fun\n")
import requests
import json
import pprint
import random
...
while endGame != "quit":
    ...
    if(r.status_code != 200):
        ...
        if user_answer == correct_answer:
            print("\nCongratulations! You answer correctly! The correct answer was: " + html.unescape(correct_answer))
            score_correct += 1
        else:
